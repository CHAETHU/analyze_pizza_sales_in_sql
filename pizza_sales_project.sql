...
/*  4. Identify the most common pizza size orderes */

select
quantity, count(order_details_id)
from order_details group by quantity;

/* 5.Identify the most common prize size ordered */
...
/* 6. list the top 5 most ordered pizza
--- types along their quantities */
...
-- group the orders by date and calculatr the average number of pizzas ordered per day 
...
-- Calculate the percentage contribution of each pizza type total revenue
...
FROM
    order_details
        JOIN
    pizzas ON pizzas.pizza_type_id = order_details.pizza_id) * 100,2 ) as revenue
